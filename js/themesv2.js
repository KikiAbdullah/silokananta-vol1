(() => {
  var e,
    ...
    i,
    s,
    r = document.getElementById("kunciKarya"),
  ...
  $();
  var ee = document.querySelectorAll(".kuncikarya_slide"),
    te = document.querySelectorAll(".kuncikarya_menu_item"),
    ne = document.getElementById("smMenu"),
    oe = document.querySelector(".kuncikarya_menu_list"),
  ...
  var se = function () {
    ...
    ge = function () {
      fe && ((fe = !1), clearInterval(autoPlay));
    };
